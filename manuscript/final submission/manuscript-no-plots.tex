...
Tropical Medicine}}\\
\bigskip
\textbf{\getAff{London School of Hygiene \& Tropical Medicine}}London
...
Theory and Statistics}}Karlsruhe Institute of Technology - Institute of
...
\textbf{\getAff{Imperial College London}}Imperial College London,
Norfolk Place, London W2 1PG, United Kingdom\\
\bigskip
* Corresponding author: nikos.bosse@lshtm.ac.uk\\
\end{flushleft}
...
\begin{figure}[H]
%\includegraphics[width=1\linewidth,]{../analysis/plots/aggregate-performance-all-v4} 
...
\begin{figure}[H]
%\includegraphics[width=1\linewidth,]{../analysis/plots/figure-forecasts-2} 
...
\begin{figure}[H]
% \includegraphics[width=1\linewidth,]{../analysis/plots/distribution_scores_wis-2} 
...
\begin{figure}[H]
% \includegraphics[width=1\linewidth,]{../analysis/plots/aggregate-performance-rel-ensemble-v4}
...
\begin{figure}[H]
%\includegraphics[width=1\linewidth,]{../analysis/plots/figure-forecasts-1} 
