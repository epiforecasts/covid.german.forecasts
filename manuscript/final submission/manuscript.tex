...
Tropical Medicine}}\\
\bigskip
\textbf{\getAff{London School of Hygiene \& Tropical Medicine}}Centre
for the Mathematical Modelling of Infectious Diseases, Department of
...
\nameref{fig:screenshot} in the SI). The default shown was a repetition
...
\nameref{tab:scoring-metrics} in the SI. All scores were calculated
...
and \nameref{fig:num-ensemble-members} in the SI). What we call ``Hub
...
\nameref{fig:performance-locations-rel}A). For two week ahead forecasts,
mean WIS relative to the Hub ensemble (= 1) was 0.89 for crowd forecasts
and 1.40 for the renewal model (\nameref{tab:score-table-2} Table).
...
\nameref{tab:score-table-2} and \nameref{tab:score-table-4}s). Despite
...
\nameref{fig:performance-locations-rel}). Due to the differing
