...
Generally, trends in overall performance were broadly similar across locations (Figure XX). However, relative to the Hub ensemble, the crowd forecasts performed better in Germany than in Poland and the renewal model better in Poland than in Germany (Figure XXA, XXG). 
