...
```{r distribution-scores-differences, fig.cap="Density plot with the difference in WIS between the Crowd forecast and the Hub ensemble (values below zero mean better performance of the Crowd forecasts)."}
