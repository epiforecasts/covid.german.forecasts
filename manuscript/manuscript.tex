...
Tables \textbackslash ref\{tab:score-table-2) and
\ref{tab:score-table-4}).

Generally, trends in overall performance were broadly similar across
locations (Figures \textbackslash ref\{fig:performance-locations) and
...
\textbackslash ref\{tab:table-ensemble-versions) in the SI.
