...
truth[, epi_class := epi_classification(true_value, first_diff), 
      by = c("location_name", "target_type")]
...
ggplot(truth, aes(x = target_end_date)) + 
  geom_rect(aes(xmin = target_end_date, xmax = shift_date, ymin = -Inf, ymax = Inf, fill = factor(epi_class)), alpha = 0.2) +
