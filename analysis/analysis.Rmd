...
p_median <- scores %>%
  ...
  theme(legend.position = "bottom") + 
  scale_color_manual(values = coldeaths) + 
  labs(y = "median WIS", x = "Forecast horizon") + 
  theme_minimal()
...
p_wis_sd <- scores %>%
  ...
  theme(legend.position = "bottom") + 
  scale_color_manual(values = coldeaths) + 
  labs(y = "WIS - standard deviation", x = "Forecast horizon") + 
  theme_minimal()
...
p_sharpness <- scores %>%
  ...
  theme(legend.position = "bottom") + 
  scale_color_manual(values = coldeaths) + 
  labs(y = "sharpness", x = "Forecast horizon") + 
  theme_minimal()
...
p_aem <- scores %>%
  ...
  theme(legend.position = "bottom") + 
  scale_color_manual(values = coldeaths) + 
  labs(y = "Absolute error", x = "Forecast horizon") + 
  theme_minimal()
...
p_cov50 <- scores[range %in% c(50)] %>%
  ...
  scale_color_manual(values = coldeaths) + 
  labs(y = "Empirical coverage", x = "Forecast horizon") + 
  theme_minimal() + 
