...
saveRDS(generation_time , here::here("rt-forecast", "data", "delays", "generation_time.rds"))
saveRDS(incubation_period, here::here("rt-forecast", "data", "delays", "incubation_period.rds"))
...
report_delay <- copy(linelist)[!is.na(delay_onset_report)]
...
onset_to_report <- estimate_delay(report_delay$delay_onset_report,
                                  ...
                                  max_value = 15)
saveRDS(onset_to_report, here("rt-forecast", "data", "delays", "onset_to_report.rds"))
